...
Receiver receiver(-4.557, -3.01, 0, 0.2241);

Transmitter transmitter(-2.0174, -2.58, 0);
...
int raytrace(Ray ray, float fieldStrength, float pathLength, vector<Object> obstacles, int presentIndex)
{
	...
	fieldStrength *= exp(-1 * pathLength * 0.05);
...
int main()
{
	...
	Object Box;
	Box.setShape(0.03, 2.5, 3);
	Box.setPosition(-3.6586, -1.72, 0);
	Box.setProperty(2, 1);
	Box.getPoints();
	obstacles.push_back(Box);

	Object Box1;
	Box1.setShape(0.91, 0.645, 3);
	Box1.setPosition(6.045, 3.9775, 0);
	Box1.setProperty(2, 1);
	Box1.getPoints();
	obstacles.push_back(Box1);

	Object Box2;
	Box2.setShape(0.91, 0.645, 3);
	Box2.setPosition(-6.045, 3.9775, 0);
	Box2.setProperty(2, 1);
	Box2.getPoints();
	obstacles.push_back(Box2);

	Object Box3;
	Box3.setShape(0.91, 0.645, 3);
	Box3.setPosition(6.045, -3.9775, 0);
	Box3.setProperty(2, 1);
	Box3.getPoints();
	obstacles.push_back(Box3);

	Object Box4;
	Box4.setShape(0.91, 0.645, 3);
	Box4.setPosition(-6.045, -3.9775, 0);
	Box4.setProperty(2, 1);
	Box4.getPoints();
